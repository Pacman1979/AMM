...
const Deposit = () => {
  ...
  const depositHandler = async (e) => {
    ...
    setShowAlert(false) // Alert not required here.
    ...
    await addLiquidity( //call the function
      provider,
      amm,
      tokens,
    ...
    await loadBalances(amm, tokens, account, dispatch) // loads the new updated balances, if changes.

    setShowAlert(true) // Need alerts available here.
  }
